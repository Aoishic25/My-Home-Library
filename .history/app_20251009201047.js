...
const shelfForeignKeys = {
    E_Writer: { table: 'writer.Egypt_Author', column: 'Ename' },
    SN_Writer: { table: 'writer.Author', column: 'Authname' },
    CH_Writer: { table: 'CH_Author', column: 'Hname' },
    A_Writer: { table: 'Folk_Author', column: 'Fname' },
    Arabia_Writer: { table: 'Arabia_Author', column: 'Arname' },
    Asia_Writer: { table: 'Asia_Author', column: 'Asname' },
    C_Writer: { table: 'C_Author', column: 'Cname' },
    I_Writer: { table: 'India_Author', column: 'Iname' },
    Myth_Writer: { table: 'Myth_Author', column: 'Mname' },
    Penguin_Writer: { table: 'Penguin_Author', column: 'Name' },
    Sr_Writer: { table: 'Sr_Author', column: 'Srname' }
};
...
app.post('/form', (req, res) => {
    ...
    conn.query(`USE ${selectedDB}`, (err) => {
        ...
        conn.query(`DESCRIBE ${selectedTable}`, async (err, results) => {
            ...
            // Only apply dropdown logic if the selected database is 'shelf'
